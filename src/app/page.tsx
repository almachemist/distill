  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-surface">
      ...
      <nav className="container mx-auto px-6 py-6">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-lg font-bold text-foreground">Distil</span>
          </div>
          <div className="flex space-x-4">
            ...
            <Link 
              href="/auth/signup"
              className="px-6 py-2 bg-copper text-white rounded-lg hover:bg-copper-hover font-medium transition-colors"
            >
              Get Started
            </Link>
          </div>
      ...
      <main className="container mx-auto px-6 py-20">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <Link 
                href="/auth/signup"
                className="px-8 py-3 bg-copper text-white rounded-lg hover:bg-copper-hover font-medium text-lg transition-colors"
              >
                Start Free Trial
              </Link>
              <Link 
                href="#features"
                className="px-8 py-3 border-2 border-border-strong text-foreground rounded-lg hover:border-copper/40 font-medium text-lg transition-colors"
              >
                Learn More
              </Link>
            </div>
        ...
        <div id="features" className="mt-32">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-surface p-8 rounded-xl shadow-card border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">Barrel Tracking</h3>
            ...
            <div className="bg-surface p-8 rounded-xl shadow-card border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">Production Orders</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-surface p-8 rounded-xl shadow-card border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">Quality Control</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-surface p-8 rounded-xl shadow-card border border-border">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">Compliance & TTB</h3>
              <p className="text-muted-foreground">
        ...
        {/* CTA Section */}
        <div className="mt-32 text-center bg-accent rounded-2xl p-12 border border-border">
          ...
          <Link 
            href="/auth/signup"
            className="inline-block px-8 py-3 bg-copper text-white rounded-lg hover:bg-copper-hover font-medium text-lg transition-colors"
          >
